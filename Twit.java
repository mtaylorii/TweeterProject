...
public class Twit {
	...
	/**
	 * Nondefault constructor that sets TwitText.
	 * @param t text to be set in TwitText
	 */
	Twit(String t) {
		this.TwitText = t;
		this.TwitPhotoPath = "~";
	...
	/**
	 * Nondefault constructor that sets TwitText and TwitPhotoPath.
	 * @param t text to be set in TwitText
	 * @param p photo path to be set in TwitPhotoPath
	 */
